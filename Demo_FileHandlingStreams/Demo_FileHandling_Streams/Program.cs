...
namespace Demo_FileHandling_Streams
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string filePath = @"C:\Users\pande\source\repos\wipro_day1\Demo_FileHandling_Streams\bin\Debug\employees.json"; // Defining the file path where the JSON string will be written
